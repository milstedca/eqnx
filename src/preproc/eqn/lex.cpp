...
/* The eqnchar definitions for MathML mode */
static struct builtin_def eqnchar_defs[] = {
  {"", "{type \"operator\" \\[u]}" },
  {"", "{type \"binary\" \\[u]}" },
  {"", "{type \"relation\" \\[u]}" },
  {"", "\\[u]" },
  ...
  {"-wig", "{type \"operator\" \\[u]}" },
  {"wig", "{type \"operator\" \\[u]}" },
  {"bbar", "{type \"operator\" \\[u]}" },
  {"ang", "{type \"operator\" \\[u]}" },
  {"rang", "{type \"operator\" \\[u]}" },
  {"ppd", "{type \"operator\" \\[u]}" },
  {"div", "{type \"operator\" \\[u]}" },
  {"blog", "{type \"operator\" \\[u]}" },
  {"5star", "{type \"operator\" \\[u]}" },
  {"cap", "{type \"operator\" \\[u]}" },
  {"incl", "{type \"operator\" \\[u]}" },
  {"oppA", "{type \"operator\" \\[u]}" },
  {"oppE", "{type \"operator\" \\[u]}" },
  {"empty", "\\[u]" },
  {"|>", "{type \"operator\" \\[u]}" },
  {"subset", "{type \"operator\" \\[u]}" },
  {"supset", "{type \"operator\" \\[u]}" },
  {"==<", "{type \"operator\" \\[u]}" },
  {"==>", "{type \"operator\" \\[u]}" },
  {"prop", "{type \"operator\" \\[u]}" },
  {"langle", "{type \"operator\" \\[u]}" },
  {"rangle", "{type \"operator\" \\[u]}" },
  {"hbar", "\\[u]" },
  {"<=>", "{type \"operator\" \\[u]}" },
  {"<->", "{type \"operator\" \\[u]}" },
  {"larrow", "{type \"operator\" \\[u]}" },
  {"rarrow", "{type \"operator\" \\[u]}" },
  {"cirplus", "{type \"operator\" \\[u]}" },
  {"bigstar", "{type \"operator\" \\[u]}" },
  {"circle", "{type \"operator\" \\[u]}" },
  {"square", "{type \"operator\" \\[u]}" },
  {"bullet", "{type \"operator\" \\[u]}" },
  {"degree", "{type \"operator\" \\[u]}" },
  {"member", "{type \"operator\" \\[u]}" },
  {"nomem", "{type \"operator\" \\[u]}" },
  {"!subset", "{type \"operator\" \\[u]}" },
  {"!supset", "{type \"operator\" \\[u]}" },
  {"quarter", "\\[u]" },
  {"3quarter", "\\[u]" },
  {"suchthat", "{type \"operator\" \\[u]}" },
  {"angstrom", "\\[u]" },
  {"orsign", "{type \"operator\" \\[u]}" },
  {"andsign", "{type \"operator\" \\[u]}" },
  {"notsign", "{type \"operator\" \\[u]}" },
  {"varrow", "{type \"operator\" \\[u]}" },
  {"uarrow", "{type \"operator\" \\[u]}" },
  {"darrow", "{type \"operator\" \\[u]}" },
